const appDetail = [
  ...
  },
  {
    ...
    insights: [
      '인앱 업데이트 도입을 통해 앱 심사를 거치지 않고도 빠르게 변경 사항을 반영할 수 있어, 긴급 대응 및 운영 유연성이 크게 향상되었다. 실제로 <b>앱에서 UI 레이아웃이 깨지는 문제와 브라우저 모듈 사용으로 인해 발생하는 버그를 빠르게 수정</b>할 수 있었다.',
      '하지만 <b>인앱 업데이트에 대한 점진적 배포(Gradual Rollout)가 제한적</b>이기 때문에, 장애 발생 시 조기 차단이나 롤백이 어렵다. 이에 따라 사전 대응을 위한 테스트 코드 강화 혹은 웹뷰로의 마이그레이션이 필요하다.',
    ],
    references: [
      {
